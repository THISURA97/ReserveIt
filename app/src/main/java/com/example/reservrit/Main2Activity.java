...
//                openMain2Activity();
                Intent intent = new Intent(Main2Activity.this, ActivityVenues.class);
        ...
        btn_loadcus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToNext()) {
                    ...
                    Toast.makeText(Main2Activity.this, "Customer Loaded", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(Main2Activity.this, "Invalid Customer ID", Toast.LENGTH_SHORT).show();
                }
