...
//                        Toast.makeText(getActivity(), "Email Sign In Failed.!", Toast.LENGTH_SHORT).show();
        ...
        btn_pres.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (time == null || date == null || pmethod == null) {
                    ...
                    database.execSQL("INSERT INTO packagereservation(cus_id,pa_id,ptime,pdate,pmethod,status) VALUES ('" + Main2Activity.customer.getId() + "','" + packid + "','" + ptime + "','" + pdate + "','" + pmethod + "',1)");
    ...
    private void init(View view) {
        ...
        tv_time = view.findViewById(R.id.tv_seltime);
        tv_date = view.findViewById(R.id.tv_seldate);
